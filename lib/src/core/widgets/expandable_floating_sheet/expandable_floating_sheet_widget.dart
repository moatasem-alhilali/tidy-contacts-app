...
class ExpandableFloatingSheetWidget extends StatefulWidget {
  const ExpandableFloatingSheetWidget({
    required this.items,
  ...
  @override
  State<ExpandableFloatingSheetWidget> createState() =>
      _ExpandableFloatingSheetWidgetState();
}

class _ExpandableFloatingSheetWidgetState
    extends State<ExpandableFloatingSheetWidget>
