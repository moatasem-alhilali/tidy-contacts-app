...
extension CustomPositionSnackbar on BuildContext {
  ...
  // helper method to show a snackbar with default parameters
  void showSuccessSnackbar(String message) {
    showCustomSnackbar(message);
  }

  void showErrorSnackbar(String message) {
    showCustomSnackbar(message, style: SnackBarType.error, customOffset: 100);
  }

  void showWarningSnackbar(String message) {
    showCustomSnackbar(message, style: SnackBarType.warning, customOffset: 100);
  }
}
