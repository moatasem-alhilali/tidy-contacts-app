            ...
            child: Stack(
              children: [
                ...
                CustomPaint(
                  ...
                  painter: GeometricShapePainterText(
...
enum CardShapeType { circles, triangles, diamonds, hexagons, stars, waves }

class GeometricShapePainterText extends CustomPainter {
  GeometricShapePainterText({
